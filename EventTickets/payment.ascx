...
<script type="text/javascript">
    ...
    function ShowCalc() {
        window.open('calc.aspx','calc', 'width=500,height=250');
    }
</script>
    ...
    <tr>
        <td style="border:0px solid black;">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    <td colspan="2" align="right"><input type="button" runat="server" id="btnCalc" value="Calculator" class="btn" Width="100px" onclick="ShowCalc();"  /></td>
                </tr>
