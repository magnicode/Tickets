            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg != "") {
                        ...
                        //$("#td_sales_serialno").show();   implement on next phase
                                ...
                                <table style="text-align:left; vertical-align:top; width:100%; height:100%" cellpadding="5"  cellspacing="0" border="0" >
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td id="amt_return">0.00</td><td style="width:50%;" align="right">
                                                        <input type="button" ID="bReturn" value="Return" Class="btn" onclick="return submitReturn();" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2" align="right" id="td_print" style="display:none; text-align:right;">
                                            ...
                                            <div id="div_printpdf" style="display:none; float:right;">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" runat="server" class="btn" value="Print Ticket PDF" id="PrintPDF" onclick="PrintPDF();"  /></div>
                                        </td>
                                    </tr>
                                    <tr><td></td></tr>
                                </table>
