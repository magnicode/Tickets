<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="paymentoptionsNew.aspx.cs" Inherits="EventTickets.SALES.paymentoptionsNew" %>
...
<script type="text/javascript">
    function OpenNumpad(paymenttype) {
        ...
        if (paymenttype == "cash") {
            ...
            var win = window.open('NumberPad.aspx?type=paymentoptions&paymenttype=cash', 'npad', 'width=312,height=530,statusbar=no');
            win.focus();
            ...
            */
            ...
            var win = window.open('NumberPad.aspx?type=paymentoptions&paymenttype=credit', 'npad', 'width=312,height=530,statusbar=no');
            win.focus();
        }
        else if (paymenttype == "voucher") {
            //var win = window.open('voucher.aspx', 'npad', 'width=500,height=300,statusbar=no');
            var win = window.open('NumberPad.aspx?type=paymentoptions&paymenttype=voucher', 'npad', 'width=312,height=530,statusbar=no');
            win.focus();
        }
