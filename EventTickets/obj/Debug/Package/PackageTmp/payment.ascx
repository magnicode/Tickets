...
<table cellpadding="0"  cellspacing="0" width="100%"  style="height:100%" border="0">
                    ...
                    <tr>
                        <td valign="top" style="padding:3px;">
                            <asp:DataList ID="dlPayment" runat="server" ShowHeader="false" ShowFooter="false" Width="100%" onitemcommand="dlPayment_ItemCommand">
                                <ItemTemplate >
                                    <div class="box-shadow" style="background-color:#d3d3d3;padding:5px 0px 5px 5px;border:1px solid #000;line-height:20px;cursor:pointer" onclick="ShowDelPayment('<%# Eval("Id").ToString()%>','<%# Eval("Status").ToString()%>')">
                                    <table width="100%" border="0" style="border:0px solid black; background-color:#d3d3d3" cellpadding="3">
                                        <tr>
                                            <td style="width:50px;"><img src="<%# Eval("ImagePath") %>" style="width=40px; height:auto;"></td>
                                            <td align="Left">
                                                <table width="100%">
                                                    <tr>
    ...
    <tr>
        <td style="height:50px; border:0px solid black;" align="right">
            <img src="../images/recycle_bin_empty.png" style="height:40px; width:auto;" />
        </td>
    </tr>
    <tr>
