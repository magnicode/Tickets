    ...
    <td align="center" width="70%"  valign="top" style="height:100%; ">
        <div class="box-shadow" style="min-height:445px; border:1px solid grey;">
            <table style="text-align:center; vertical-align:top; width:100%; height:100%" cellpadding="0"  cellspacing="0" border="0" >
                <tr>
                    <td colspan="2" align="center" style="font-size:22px; background-color:#cccccc; font-weight:bold; vertical-align:top; color:Black; height:30px;">Authorization</td>
                </tr>
                <tr><td colspan="2" style="height:10px;"></td></tr>
                <tr>
                    <td colspan="2" align="left" style="height:335px; vertical-align:top; padding-left:10px;" valign="top">
